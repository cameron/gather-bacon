...
DATABASES = {
    'default': {
        ...
        'PORT': int(os.environ['DB_PORT_5432_TCP_PORT']),
...
SECRET_KEY = 'VIME/sePCnDoARsjkGs+BcUlEPJK7ejWEKnoTpIOKpatCDn1CYVF1g=='
...
# custom nodestore
SENTRY_NODESTORE='datahog_nodestore.NodeStorage'
